...
*       Determine evolution time scales for first star.
      ...
      M1 = M(I1)
      AGE1 = AJ(I1)
      CALL METISSE_star(K1,M01,M1,TMS1,TN,TSCLS,LUMS,GB,ZPARS,DTM,I1)
*
*       Obtain time scales for second star.
      M02 = M0(I2)
      M2 = M(I2)
      AGE2 = AJ(I2)
      CALL METISSE_star(K2,M02,M2,TMS2,TN,TSCLS,LUMS,GB,ZPARS,DTM,I2)
*
...
*       Specify new age based on complete mixing.
         IF(K1.EQ.7) KW = 7
         CALL METISSE_star(KW,M03,M3,TMS3,TN,TSCLS,LUMS,GB,ZPARS,DTM,1)
